...
export default createTheme({
  ...
  tokens: {
    ...
    colors: {
      ...
      brand: {
        primary: {
          10: { value: "hsl(180, 87%, 97%)" },
          20: { value: "hsl(180, 89%, 96%)" },
          40: { value: "hsl(180, 84%, 95%)" },
          60: { value: "hsl(180, 87%, 94%)" },
          80: { value: "hsl(180, 17%, 75%)" },
          90: { value: "hsl(180, 7%, 56%)" },
          100: { value: "hsl(180, 6%, 47%)" },
        },
        secondary: {
          10: { value: "hsl(186, 67%, 94%)" },
          20: { value: "hsl(185, 68%, 93%)" },
          40: { value: "hsl(185, 67%, 90%)" },
          60: { value: "hsl(186, 67%, 88%)" },
          80: { value: "hsl(185, 22%, 70%)" },
          90: { value: "hsl(185, 10%, 53%)" },
          100: { value: "hsl(186, 9%, 44%)" },
        },
      },
      font: {
