...
import { createGoods } from "../../amplify/backend/api/trademate/build/functions/mutations";
const client = generateClient();
export default function GoodsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setListedDate(initialValues.ListedDate);
    setPrice(initialValues.Price);
    setLocation(initialValues.Location);
    setContact(initialValues.Contact);
    setHolder(initialValues.Holder);
    setErrors({});
  };
  const validations = {
    Name: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createGoods.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "GoodsCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
